  ...
  constructor({ name, email, password }, validatePassword = true) {
    ...
    let userShape = {
      name: yup.string()
        ...
        .min(userConstants.USER_NAME_MIN_LENGTH,
          userConstants.USER_NAME_MIN_LENGTH_MESSAGE)
        .max(userConstants.USER_NAME_MAX_LENGTH,
          userConstants.USER_NAME_MAX_LENGTH_MESSAGE),
      email: yup.string()
    ...
    if (validatePassword) {
      ...
      userShape.password = yup.string()
        .required(userConstants.USER_PASSWORD_REQUIRED_MESSAGE);
    }
