...
describe('Auth class', () => {
    describe('#Validation', () => {
        ...
        it("#should be invalid when email is missing", async (done) => {
            ...
            expect(credentials.errors.includes(authConstants.AUTH_EMAIL_REQUIRED_MESSAGE)).toBeTruthy();
            done();
        });
        ...
        it("#should be invalid when password is missing", async (done) => {
            ...
            expect(isValid).toBeFalsy();
            expect(credentials.errors.includes(authConstants.AUTH_PASSWORD_REQUIRED_MESSAGE)).toBeTruthy();
            done();
        });
        ...
        it("#should be invalid when the email isn't in a valid format", async (done) => {
            ...
            expect(isValid).toBeFalsy();
            expect(credentials.errors.includes(authConstants.AUTH_EMAIL_FORMAT_MESSAGE)).toBeTruthy();
            done();
        });
    })
})